...
var useProvideServiceWorker = function useProvideServiceWorker(file) {
  ...
  var _React$useReducer = React.useReducer(useServiceWorkerReducer, initialState),
      swState = _React$useReducer[0],
      dispatch = _React$useReducer[1];

  React.useEffect(function () {
    registerServiceWorker.register(file, {
...
exports.SERVICE_WORKER_CACHED = SERVICE_WORKER_CACHED;
exports.SERVICE_WORKER_ERROR = SERVICE_WORKER_ERROR;
exports.SERVICE_WORKER_OFFLINE = SERVICE_WORKER_OFFLINE;
exports.SERVICE_WORKER_READY = SERVICE_WORKER_READY;
exports.SERVICE_WORKER_REGISTERED = SERVICE_WORKER_REGISTERED;
exports.SERVICE_WORKER_UPDATE_FOUND = SERVICE_WORKER_UPDATE_FOUND;
exports.SERVICE_WORKER_UPDATE_READY = SERVICE_WORKER_UPDATE_READY;
exports.useServiceWorker = useServiceWorker;
//# sourceMappingURL=react-hook-use-service-worker.cjs.development.js.map
